...
import DisabledUploadButton from '../components/settings-content/upload-block/upload-file-block/upload-button/disabled-upload-button/disabled-upload-button';
